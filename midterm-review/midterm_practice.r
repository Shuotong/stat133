...
m <- matrix(seq(10,120, by = 10),3,4,byrow = TRUE )
...
n <- data.frame(num = c(1:10), lett = letters[1:10], even = ifelse(c(1:10) %% 2 == 0,TRUE, FALSE))
...
set.seed(42)
nmat <- matrix(rnorm(100*100, 6, 2), 100, 100)
